        ...
        <div className="section-inner">
          <div className="how-grid">
            <div className="how-head">
              ...
              <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: 16, lineHeight: 1.65 }}>All three tiers available for HVAC contractors. One HVAC company per trade per market in the Carolinas.</p>
            </div>
